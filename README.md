...
<ul>
  ...
  <li>
    ...
    <h4>Implementacion</h4>
    <img src="/Imagenes/Bridge/ejemploBridge.jpg" alt="Ejemplo Bridge" width="670" height="300">
  </li>
  <li>
    Composite
    ...
    <h4>Implementacion</h4>
    <img src="/Imagenes/Composite/ejemploComposite.gif" alt="Ejemplo Composite" width="650" height="300">
  </li>
  <li>
    Decorator
    ...
    <h4>Implementacion</h4>
    <img src="/Imagenes/Decorator/ejemploDecorator.jpg" alt="Ejemplo Decorator" width="650" height="400">
  </li>
  <li>
    Facade
    ...
    <h4>Implementacion</h4>
    <img src="/Imagenes/Facade/ejemploFacade.jpg" alt="Ejemplo Facade" width="600" height="450">
  </li>
  <li>
    Flyweight
    ...
    <h4>Implementacion</h4>
    <img src="/Imagenes/Flyweight/ejemploFlyweight.gif" alt="Ejemplo Flyweight" width="600" height="450">
  </li>
  <li>
    Proxy
    ...
    <h4>Implementacion</h4>
    <img src="/Imagenes/Proxy/ejemploProxy.png" alt="Ejemplo Proxy" width="600" height="450">
  </li>
</ul>
